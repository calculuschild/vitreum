...
module.exports = async (entrypoint, _opts={})=>{
	...
	const pack = async ()=>{
		...
		const clientSideHydrate = `;start_app=(props={},target=document.getElementById('reactRoot'))=>require('react-dom/client').hydrateRoot(target,require('react').createElement(${opts.name}, props));`
